  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="container py-24 md:py-32">
        <Card className="mx-auto max-w-2xl border-border/60 bg-card/60 p-10 text-center md:p-16">
          ...
          <h1 className="mt-6 font-display text-3xl font-bold md:text-4xl">{title}</h1>
